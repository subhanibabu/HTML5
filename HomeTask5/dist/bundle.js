...
/***/ "./node_modules/css-loader/dist/cjs.js!./src/HomeTask3.css":
/*!*****************************************************************!*\
  !*** ./node_modules/css-loader/dist/cjs.js!./src/HomeTask3.css ***!
  \*****************************************************************/
/*! no static exports found */
...
window.addEventListener('load', function () {
  var model = new _Model_js__WEBPACK_IMPORTED_MODULE_2__["default"]();
  var view = new _View_js__WEBPACK_IMPORTED_MODULE_3__["default"](model);
  var controller = new _Controller_js__WEBPACK_IMPORTED_MODULE_4__["default"](model, view);
  view.loadView();
});
...
var Controller = function Controller(model, view) {
  ...
  _defineProperty(this, "selectCategory", function (category) {
    for (var i = 1; i < 11; i++) {
      if (category === 0 && i === 1 || category === i) {
        ...
        var _tittle = document.getElementById("tittle" + i);

        _tittle.style.display = "block";
        _tittle.className = 'section line';
      } else {
        var _tittle2 = document.getElementById("tittle" + i);

        _tittle2.style.display = "none";
      }
    }
  });

  _defineProperty(this, "openPopUp", function (value) {
    // getter example
    var news = {
  ...
  _defineProperty(this, "validateEmail", function () {
    // setter example
    var email = {
      alertMessage: "",
...
var content = __webpack_require__(/*! !../node_modules/css-loader/dist/cjs.js!./HomeTask3.css */ "./node_modules/css-loader/dist/cjs.js!./src/HomeTask3.css");
...
function () {
  ...
  _createClass(Model, [{
    key: "getAPIData",
    value: function () {
      var _getAPIData = _asyncToGenerator(
      /*#__PURE__*/
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _context.next = 3;
                return fetch("https://newsapi.org/v2/top-headlines?sources=techcrunch&apiKey=3965cc2342c54e7caa002ab6bf398348");
...
/* harmony import */ var _src_HomeTask3_css__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../src/HomeTask3.css */ "./src/HomeTask3.css");
/* harmony import */ var _src_HomeTask3_css__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_src_HomeTask3_css__WEBPACK_IMPORTED_MODULE_1__);
...
function (_Controller) {
  ...
  function View(model) {
    ...
    _defineProperty(_assertThisInitialized(_this), "loadView", function () {
      _this._model.getAPIData().then(function (response) {
        ...
        _this.createDOM(json);
      });
    });

    _defineProperty(_assertThisInitialized(_this), "createDOM", function (jsondata) {
      document.body.appendChild(_this.header());
      ...
      leftdiv.appendChild(_this.createModal());

      _this.fillNewsContent(leftdiv, jsondata);

      var rightdiv = document.createElement('div');
      maindiv.appendChild(_this.generateCategories(rightdiv));

      _this.generateOptions();

      document.body.appendChild(_this.footerComponent());
    });

    _defineProperty(_assertThisInitialized(_this), "createModal", function () {
    ...
    _defineProperty(_assertThisInitialized(_this), "fillNewsContent", function (leftdiv, data) {
      for (var i = 1; i < 11; i++) {
        ...
        continuereading.addEventListener('click', function (e) {
          return _this.openPopUp(e.target.value);
        });
    ...
    _defineProperty(_assertThisInitialized(_this), "generateCategories", function (rightdiv) {
      rightdiv.id = 'right';
      ...
      select.addEventListener('change', function (e) {
        return _this.selectCategory(e.target.selectedIndex);
      });
    ...
    _defineProperty(_assertThisInitialized(_this), "generateOptions", function () {
      for (var i = 0; i < 11; i++) {
        ...
        if (i === 0) {
          ...
          var text = document.createTextNode("News Channel - ".concat(i)); //template strings
        }
    ...
    _defineProperty(_assertThisInitialized(_this), "header", function () {
      ...
      headerp.appendChild(_this.emailComponent());
      return header;
    });

    _defineProperty(_assertThisInitialized(_this), "emailComponent", function () {
      ...
      newsheadlines.addEventListener('click', function () {
        return _this.getNewsHeadLines();
      });
    ...
    _defineProperty(_assertThisInitialized(_this), "footerComponent", function () {
  ...
  return View;
}(_Controller_js__WEBPACK_IMPORTED_MODULE_0__["default"]);
